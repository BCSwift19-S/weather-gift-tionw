        ...
        Alamofire.request(weatherURL).responseJSON { response in
            ...
            case .success(let value):
                ...
                for day in 1...dailyDataArray.count-1{
                    ...
                    let dailySumamry = json["daily"]["data"][day]["summary"].stringValue
                    let newDailyForecast = DailyForecast(dailyMaxTemp: maxTemp, dailyMinTemp: minTemp, dailySummary: dailySumamry, dailyDate: dateValue, dailyIcon: icon)
